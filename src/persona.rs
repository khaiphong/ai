/*
 ...
 highest meaning of the noble #Truth" which is a fact-based epistemic objective and HuiNeng's
 specialized contributions about (1) the Three-Not (Wu-Nien, No-Mark, Detachment / Vô Niệm, Vô
 Vết, Vô Trụ), (2) #DhyanaSamadhi / Thiền Định, (3) #SamadhiPrajna / Định-Tuệ" leading to KP
 ...
 complex Fibonacci sequence - testable with KP KienTanh / HuiNeng WuNien / Gotama's
